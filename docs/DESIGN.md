...
> Design notes for **approved-payment-sms-go** — a runnable go example that Go service for approved payment SMS templates and signatures.
...
- **Feature code** — the actual task: fintech-sms-compliance.
