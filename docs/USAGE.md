...
The single thin client is the seam: add a method that calls another `/v1/...` route (e.g. one of sms.send, sms.signature.create, sms.template.create) and reuse it from your own code.
